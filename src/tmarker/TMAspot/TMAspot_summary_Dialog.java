...
public class TMAspot_summary_Dialog extends javax.swing.JDialog {
    ...
    private final Dimension smallPlotDim = new Dimension(300, 300);
    private final int nbins = 256;
            ...
            if ((labelers.size()==1 && !es.isEmpty()) || (labelers.size()>1)) {
                ...
                for (Byte gsnum:labelers) {
                    ...
                    if (tmarker.DEBUG>3) {
                        ...
                        java.util.logging.Logger.getLogger(getClass().getName()).log(java.util.logging.Level.INFO, "    {0}", Arrays.toString(stats));
                        java.util.logging.Logger.getLogger(getClass().getName()).log(java.util.logging.Level.INFO, "  Matchstatistics es vs. gs");
                        java.util.logging.Logger.getLogger(getClass().getName()).log(java.util.logging.Level.INFO, "    {0}", Arrays.toString(statst));
                    }
                ...
                if (((java.awt.BorderLayout)(jPanel14.getLayout())).getLayoutComponent(java.awt.BorderLayout.CENTER) != null) {
                    ...
                    chart = ChartFactory.createBoxAndWhiskerChart("Match Statistics", "", "Performance", (BoxAndWhiskerCategoryDataset)dataset, true);
